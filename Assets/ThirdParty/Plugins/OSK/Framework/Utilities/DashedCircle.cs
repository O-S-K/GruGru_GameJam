...
namespace SquadHeroes
{
    ...
    {
        public float DOTTED_LINE_TICKNESS_RATIO = 2.5f;
        public int NUM_CAP_VERTICES = 100;
        ...
        public void SetRadius(float pRadius)
        {
            ...
            if (isDotted)
                tickness *= DOTTED_LINE_TICKNESS_RATIO;
            ...
            int numberOfVertices = Mathf.CeilToInt(2 * Mathf.PI / th) * 3;
